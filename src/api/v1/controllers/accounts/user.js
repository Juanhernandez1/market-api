...
function userAccounts(router) {
  ...
  router.put(
    "/accounts/users/complete-accounts",
    [userCompleteAccountValidationRules()],
    [authVerify, isUser, validate],
    async function (req, res) {
      const { body: user } = req;
  ...
  router.put(
    "/accounts/users/profiles/update/:user_id",
    updateProfileUserValidationRules(),
    [authVerify, isUser, validate],
    async function (req, res) {
      const { body: user } = req;
